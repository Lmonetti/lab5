...
exports.view = function(req, res){
    ...
    'friends': [
      ...
      { 'name': 'Grace Hopper',
		    ...
		    'imageURL': "http://www.ibackgroundwallpaper.com/wp-content/uploads/2014/02/emily-rudd-model.jpg"     
      },
      { 'name': 'Allen Newell',
        'description': "Really into psychology",
		    'imageURL': "https://latimesherocomplex.files.wordpress.com/2013/08/channingtatum.jpg?w=600&h=400"
      }
    ]
  }
